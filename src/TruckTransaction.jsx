...
//   const { truckNo, transactionDate, cityName, amountPerTon, truckWeight, deliverPoint } = formData;

//   if (!truckNo || !transactionDate || !cityName || !amountPerTon || !truckWeight || !deliverPoint) {
//     alert('Please fill in all the required fields.');
//     return;
//   }

//   // Check if any row is missing required fields (Plant, Slip No, Qty, Priority)
...
//   // If all required fields are filled, proceed with the submit logic
//   let dataToSubmit = [...tableData];
//   const isNewRowFilled = newRow.plantName || newRow.loadingSlipNo || newRow.qty || newRow.priority || newRow.remarks;
    ...
    <div className="min-h-screen bg-gradient-to-br from-indigo-100 to-gray-50 py-8">
      ...
      <div className="max-w-4xl mx-auto bg-white rounded-2xl shadow-xl p-6 md:p-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
          <div>
            <label className="font-medium text-slate-700 mb-1 block">
              Amount per Ton <span className="text-red-500">*</span>
            </label>
            <input
              type="text"
              name="amountPerTon"
          ...
          <div>
            <label className="font-medium text-slate-700 mb-1 block">
              Truck Weight <span className="text-red-500">*</span>
            </label>
            <input
              type="text"
              name="truckWeight"
        ...
        <div className="my-8">
          <h2 className="text-xl font-semibold text-slate-700 mb-4">Transaction Details</h2>
          <div className="overflow-x-auto bg-white shadow-lg rounded-lg">
            <table className="min-w-full table-auto">
              <thead>
                <tr className="text-left bg-indigo-50">
                  <th className="px-4 py-2 text-sm font-semibold text-slate-600">Plant Name</th>
                  <th className="px-4 py-2 text-sm font-semibold text-slate-600">Loading Slip No</th>
                  <th className="px-4 py-2 text-sm font-semibold text-slate-600">Qty</th>
                  <th className="px-4 py-2 text-sm font-semibold text-slate-600">Priority</th>
                  <th className="px-4 py-2 text-sm font-semibold text-slate-600">Remarks</th>
